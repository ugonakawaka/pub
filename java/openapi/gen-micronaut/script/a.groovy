@Grab(group = 'org.openapitools', module = 'openapi-generator-cli', version = '6.0.1')
...
def generator(String yamlName, String type, String g) {
  ...
  xxx = ['generate', 
  '-i', "${project.basedir}/specs/5G_APIs-master/${yamlName}.yaml", 
...
for( String values : ss ) {
  ...
  MyJavaClientCodegen.main(generator(values, "server", "java-micronaut-server"))
  MyJavaClientCodegen.main(generator(values, "client", "java-micronaut-client"))
}
