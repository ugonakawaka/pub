...
@Size(min = 1) 
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(grantType, nfInstanceId, scope, nfType, targetNfType, targetNfInstanceId, requesterPlmn, requesterPlmnList, requesterSnssaiList, requesterFqdn, requesterSnpnList, targetPlmn, targetSnssaiList, targetNsiList, targetNfSetId, targetNfServiceSetId, hnrfAccessTokenUri);
  }
