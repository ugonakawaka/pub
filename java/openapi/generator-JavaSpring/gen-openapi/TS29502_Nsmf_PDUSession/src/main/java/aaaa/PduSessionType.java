...
import aaaa.PduSessionTypeAnyOf;
 ...
 */
@ApiModel(description = "PduSessionType indicates the type of a PDU session. It shall comply with the provisions defined in table 5.4.3.3-1.")
...
public class PduSessionType   {
  ...
  public String toString() {
    ...
    sb.append("class PduSessionType {\n");
