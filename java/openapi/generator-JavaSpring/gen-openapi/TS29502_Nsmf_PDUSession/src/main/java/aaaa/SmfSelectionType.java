...
import aaaa.SmfSelectionTypeAnyOf;
 ...
 */
@ApiModel(description = "Smf Selection Type. Possible values are   - CURRENT_PDU_SESSION   - NEXT_PDU_SESSION ")
...
public class SmfSelectionType   {
  ...
  public String toString() {
    ...
    sb.append("class SmfSelectionType {\n");
