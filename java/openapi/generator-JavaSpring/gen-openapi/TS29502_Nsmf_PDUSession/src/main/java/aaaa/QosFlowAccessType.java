...
import aaaa.QosFlowAccessTypeAnyOf;
 ...
 */
@ApiModel(description = "Access type associated with a QoS Flow. Possible values are   - 3GPP   - NON_3GPP   - 3GPP_AND_NON_3GPP ")
...
public class QosFlowAccessType   {
  ...
  public String toString() {
    ...
    sb.append("class QosFlowAccessType {\n");
