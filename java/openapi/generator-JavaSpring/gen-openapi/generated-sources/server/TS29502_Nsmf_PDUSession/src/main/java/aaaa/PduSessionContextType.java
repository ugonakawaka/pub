...
import aaaa.PduSessionContextTypeAnyOf;
 ...
 */
@ApiModel(description = "Type of PDU Session information. Possible values are   - AF_COORDINATION_INFO ")
...
public class PduSessionContextType   {
  ...
  public String toString() {
    ...
    sb.append("class PduSessionContextType {\n");
