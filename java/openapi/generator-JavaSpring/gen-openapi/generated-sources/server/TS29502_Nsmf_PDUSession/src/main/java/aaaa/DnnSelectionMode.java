...
import aaaa.DnnSelectionModeAnyOf;
 ...
 */
@ApiModel(description = "DNN Selection Mode. Possible values are - VERIFIED - UE_DNN_NOT_VERIFIED - NW_DNN_NOT_VERIFIED ")
...
public class DnnSelectionMode   {
  ...
  public String toString() {
    ...
    sb.append("class DnnSelectionMode {\n");
