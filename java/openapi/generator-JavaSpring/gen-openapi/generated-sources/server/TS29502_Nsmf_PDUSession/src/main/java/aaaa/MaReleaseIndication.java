...
import aaaa.MaReleaseIndicationAnyOf;
 ...
 */
@ApiModel(description = "Multi-Access PDU session release Indication. Possible values are   - REL_MAPDU_OVER_3GPP   - REL_MAPDU_OVER_N3GPP ")
...
public class MaReleaseIndication   {
  ...
  public String toString() {
    ...
    sb.append("class MaReleaseIndication {\n");
