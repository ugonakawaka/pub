...
import aaaa.NotificationCauseAnyOf;
 ...
 */
@ApiModel(description = "Cause for generating a notification. Possible values are - QOS_FULFILLED - QOS_NOT_FULFILLED - UP_SEC_FULFILLED - UP_SEC_NOT_FULFILLED ")
...
public class NotificationCause   {
  ...
  public String toString() {
    ...
    sb.append("class NotificationCause {\n");
