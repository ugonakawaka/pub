...
public class TestDontLogging6_success4 {
	...
	public static class Shutdown extends DefaultShutdownCallbackRegistry {
		...
		public Cancellable addShutdownCallback(Runnable callback) {
			...
			// これを読んではだめなので、ここでフィルタリングする
			// super.addShutdownCallback(callback);
	...
	static {
		...
		System.setProperty("log4j.shutdownCallbackRegistry", "main2.TestDontLogging6_success4$Shutdown");
