 ...
 * https://raw.githubusercontent.com/DjDCH/Log4j-StaticShutdown/master/src/main/java/com/djdch/log4j/StaticShutdownCallbackRegistry.java
 */

/**
 * ShutdownRegistrationStrategy designed to be manually invoked. If not invoked,
 * log4j will not shutdown properly.
 *
...
public class StaticShutdownCallbackRegistry implements ShutdownCallbackRegistry, LifeCycle, Runnable, Serializable {
	...
	public Cancellable addShutdownCallback(final Runnable callback) {
		...
		throw new IllegalStateException(
				"Cannot add new shutdown hook as this is not started. Current state: " + state.get().name());
	}
