...
import aaaa.ProtectionResultAnyOf;
 ...
 */
@ApiModel(description = "Protection Result of the security policy indicated as \"preferred\". Possible values are   - PERFORMED   - NOT_PERFORMED ")
