...
public class TestIpv6 {
	...
	static class Ipv6Range implements IIpv6RangeCompareBase {
		...
		public String toString() {
			return String.format("%s(%s) %s(%s)", start, this.startBigInteger, end, this.endBigInteger);
		}
	}
	...
	static void a() {
...

		{
			...
			// Ipv6RangeKey ipv6RangeKey = new Ipv6RangeKey("250e:0060:0000:0000:0000:0000:0000:0001");
